...
from devterminal.skills.parser import SkillDef, SkillParseError, parse_frontmatter, parse_skill_file

log = logging.getLogger(__name__)

PROJECT_SKILLS_DIR = ".devterminal/skills"
USER_SKILLS_DIR = "~/.devterminal/skills"
...
class SkillLoader:
    ...
    def _load_builtins(self) -> list[SkillDef]:
        results: list[SkillDef] = []
        builtins_pkg = importlib.resources.files("devterminal.skills.builtins")
        ...
        for resource in builtins_pkg.iterdir():
            ...
            try:
                ...
                from devterminal.skills.parser import _validate_meta
