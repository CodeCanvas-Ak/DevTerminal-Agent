...
from devterminal.skills.parser import SkillDef, substitute_arguments
from devterminal.tools import ToolRegistry

if TYPE_CHECKING:
    from devterminal.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from devterminal.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
