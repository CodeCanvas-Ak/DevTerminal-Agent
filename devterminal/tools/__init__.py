...
from devterminal.tools.base import Tool
...
def create_default_registry(file_cache: FileCache | None = None, file_history: Any = None) -> ToolRegistry:
    ...
    from devterminal.tools.edit_file import EditFile
    from devterminal.tools.file_state_cache import FileStateCache
    from devterminal.tools.glob import Glob
    from devterminal.tools.grep import Grep
