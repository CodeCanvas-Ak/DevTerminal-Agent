...
if TYPE_CHECKING:
    ...
    from devterminal.client import LLMClient
...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from devterminal.agents.fork import ForkError, build_forked_messages
        from devterminal.agents.parser import AgentDef
        from devterminal.agents.tool_filter import resolve_agent_tools
        from devterminal.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from devterminal.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from devterminal.agents.fork import ForkError, build_forked_messages
        from devterminal.agents.parser import AgentDef
        from devterminal.agents.tool_filter import build_teammate_tools
        from devterminal.agent import Agent as AgentClass
        from devterminal.conversation import ConversationManager
        from devterminal.permissions import (
            DangerousCommandDetector,
        ...
        from devterminal.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from devterminal.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from devterminal.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from devterminal.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from devterminal.client import create_client
        from devterminal.config import ProviderConfig
