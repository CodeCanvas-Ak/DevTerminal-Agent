...
class TeamCreateTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from devterminal.teams.backend_detect import BackendDetectionError
        ...
        coordinator_note = ""
        from devterminal.teams.coordinator import is_coordinator_mode
        if is_coordinator_mode(self._enable_coordinator_mode):
            from devterminal.agents.tool_filter import apply_coordinator_filter
