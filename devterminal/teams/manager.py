...
from devterminal.teams.mailbox import Mailbox, create_message
...
from devterminal.teams.progress import TeammateProgress
from devterminal.teams.registry import AgentNameRegistry
from devterminal.teams.shared_task import SharedTaskStore
from devterminal.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from devterminal.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
