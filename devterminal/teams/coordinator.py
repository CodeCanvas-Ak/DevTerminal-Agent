...
def get_coordinator_system_prompt(agent_catalog: list[tuple[str, str]] | None = None) -> str:
    ...
    return """You are DevTerminal Agent, an AI assistant that orchestrates software engineering tasks across multiple workers.
...
def get_coordinator_user_context(
    ...
    if worker_tools is None:
        from devterminal.agents.tool_filter import IN_PROCESS_TEAMMATE_ALLOWED_TOOLS
