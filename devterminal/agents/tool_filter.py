...
def build_teammate_tools(
    ...
    from devterminal.tools.send_message import SendMessageTool
    from devterminal.tools.task_create import TaskCreateTool
    from devterminal.tools.task_get import TaskGetTool
    from devterminal.tools.task_list import TaskListTool
    from devterminal.tools.task_update import TaskUpdateTool
