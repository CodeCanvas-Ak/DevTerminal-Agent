...
PROJECT_AGENTS_DIR = ".devterminal/agents"
USER_AGENTS_DIR = "~/.devterminal/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("devterminal.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from devterminal.agents.parser import parse_frontmatter, _validate_agent_meta
