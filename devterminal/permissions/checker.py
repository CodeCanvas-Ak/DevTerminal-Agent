...
from devterminal.permissions.dangerous import DangerousCommandDetector, is_safe_command
from devterminal.permissions.modes import DecisionEffect, PermissionMode, mode_decide
from devterminal.permissions.rules import RuleEngine, extract_content
...
class PermissionChecker:
    ...
    def _is_plan_file(self, target_path: str) -> bool:
        if not self.plan_file_path or not target_path:
            return ".devterminal/plans/" in target_path
        try:
