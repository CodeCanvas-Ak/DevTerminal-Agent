"""DevTerminal Agent 的系统提示词（system prompt）构建。"""
...
IDENTITY_SECTION = PromptSection(
    ...
    priority=0,
    content=(
        "You are DevTerminal Agent, an AI programming assistant running in the terminal. "
...
def build_system_prompt(
    ...
    if coordinator_mode:
        from devterminal.teams.coordinator import get_coordinator_system_prompt
