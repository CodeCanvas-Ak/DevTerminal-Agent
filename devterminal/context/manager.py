...
from devterminal.serialization import build_messages
...
SESSION_SUBDIR = ".devterminal/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from devterminal.tools.base import StreamEnd, StreamEvent, TextDelta
