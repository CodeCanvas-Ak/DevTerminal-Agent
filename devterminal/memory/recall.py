...
SELECTOR_SYSTEM_PROMPT = (
    "You are selecting memories that will be useful to DevTerminal Agent as it processes "
    ...
    "DevTerminal Agent as it processes the user's query (up to 5). Only include memories "
    ...
    "that are usage reference or API documentation for those tools (DevTerminal Agent is "
