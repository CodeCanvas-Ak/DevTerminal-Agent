...
from devterminal.commands.parser import complete, parse_command
from devterminal.commands.registry import (
    Command,
    CommandContext,
    CommandRegistry,
    CommandType,
...
class TestHelpHandler:
    ...
    async def test_list_all(self) -> None:
        ...
        from devterminal.commands.handlers.help import handle_help
...
class TestPlanDoHandlers:
    ...
    async def test_plan_switches_mode(self) -> None:
        from devterminal.commands.handlers.plan import handle_plan
    ...
    async def test_do_switches_back(self) -> None:
        from devterminal.commands.handlers.do import handle_do
...
class TestSkillHandler:
    ...
    async def test_skill_list_no_loader(self) -> None:
        from devterminal.commands.handlers.skill import handle_skill
...
class TestStatusHandler:
    ...
    async def test_status_output(self) -> None:
        from devterminal.commands.handlers.status import handle_status
        ...
        assert "DevTerminal Agent 状态" in ui.messages[0]
        assert "default" in ui.messages[0]

class TestSessionHandler:
    @pytest.mark.asyncio
    async def test_session_no_manager(self) -> None:
        from devterminal.commands.handlers.session import handle_session
...
class TestMemoryHandler:
    ...
    async def test_memory_display(self) -> None:
        from devterminal.commands.handlers.memory import handle_memory
