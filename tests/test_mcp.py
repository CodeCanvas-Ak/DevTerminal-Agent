...
from devterminal.config import (
    AppConfig,
    ConfigError,
    MCPServerConfig,
    build_child_env,
...
class TestMCPToolWrapper:
    def test_name_format(self) -> None:
        ...
        from devterminal.mcp.tool_wrapper import MCPToolWrapper
        from devterminal.mcp.client import MCPClient
...
class TestExtractText:
    def test_text_content(self) -> None:
        from mcp import types as mcp_types
        from devterminal.mcp.tool_wrapper import _extract_text
...
class TestMCPManagerPartialFailure:
    ...
    async def test_single_server_failure_does_not_block_others(self) -> None:
        from devterminal.mcp.manager import MCPManager
        ...
        with patch("devterminal.mcp.manager.MCPClient") as MockClient:
